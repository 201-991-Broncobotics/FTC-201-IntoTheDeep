...
public class LeftSpecimen3BasketAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        TrajectoryActionBuilder DriveToChamber1 = drive.actionBuilder(startPose)
                ...
                .strafeToConstantHeading(tileCoords(-0.2, -1.2), VelConstraint);

        TrajectoryActionBuilder DriveToSample1 = drive.actionBuilder(new Pose2d(tileCoords(-0.2, -1.2), Math.toRadians(90)))
        ...
        TrajectoryActionBuilder DriveToBasket1 = drive.actionBuilder(new Pose2d(tileCoords(-1.5, -1.6), Math.toRadians(135)))
                .strafeToLinearHeading(tileCoords(-2.45, -2.4), Math.toRadians(225), VelConstraint);

        TrajectoryActionBuilder DriveToSample2 = drive.actionBuilder(new Pose2d(tileCoords(-2.5, -2.5), Math.toRadians(225)))
                .strafeToLinearHeading(tileCoords(-1.95, -1.6), Math.toRadians(135), VelConstraint);

        TrajectoryActionBuilder DriveToBasket2 = drive.actionBuilder(new Pose2d(tileCoords(-1.95, -1.6), Math.toRadians(135)))
                .strafeToLinearHeading(tileCoords(-2.45, -2.4), Math.toRadians(225), VelConstraint);

        TrajectoryActionBuilder DriveToSample3 = drive.actionBuilder(new Pose2d(tileCoords(-2.5, -2.5), Math.toRadians(225)))
                .strafeToLinearHeading(tileCoords(-2.4, -1.6), Math.toRadians(135), VelConstraint);

        TrajectoryActionBuilder DriveToBasket3 = drive.actionBuilder(new Pose2d(tileCoords(-2.4, -1.6), Math.toRadians(135)))
                .strafeToLinearHeading(tileCoords(-2.45, -2.4), Math.toRadians(225), VelConstraint);

        TrajectoryActionBuilder ParkAtRungs = drive.actionBuilder(new Pose2d(tileCoords(-2.5, -2.5), Math.toRadians(225)))
