...
public class FollowerConstants {
    ...
    private static double xMovement = 75;
    private static double yMovement = 75;
    ...
    public static double translationalPIDFFeedForward = 0.015; // 0.0
    ...
    public static double forwardZeroPowerAcceleration = -80;
