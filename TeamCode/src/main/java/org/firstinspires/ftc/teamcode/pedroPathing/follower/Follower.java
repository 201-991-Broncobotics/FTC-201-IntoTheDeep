...
public class Follower extends SubsystemBase {
    ...
    // Haha just another path planner to override everything and embed diffy code into... the last one only took a month
    Telemetry telemetry;
    ...
    public DifferentialSwerveDrive getRRDrive() {
        return drive;
    }
    ...
    public PedroTrajectoryActionBuilder actionBuilder(Pose2d beginPose) {
        return new PedroTrajectoryActionBuilder(new PathBuilder(), beginPose, this);
    }
