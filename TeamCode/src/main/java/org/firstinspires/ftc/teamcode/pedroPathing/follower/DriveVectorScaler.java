...
public class DriveVectorScaler {
     ...
     */
    public PoseVelocity2d getDrivePowers(Vector correctivePower, Vector headingPower, Vector pathingPower, double robotHeading) {
        ...
        // I am not going to bother with figuring out all of that ^ so I am just going to reverse the math of a mecanum to get the drive vectors

        return new PoseVelocity2d(new Vector2d((wheelPowers[0] - wheelPowers[1]) / 2, (wheelPowers[0] + wheelPowers[2]) / 2), (wheelPowers[0] - wheelPowers[3]) / 2);
        /*
